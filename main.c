...
int BUFFER_MEMORY_START_COUNT = 0x000200000;
...
void main(void)
{
	...
	WDTCTL = WDTPW | WDTCNTCL;																//clear timer constantly to prevent timeout.
	BUFFER_MEMORY_START_COUNT = BUFFER_MEMORY_START+ (4096*sectorcount);					//Memory address for the next sector to be erased and programmed.
	delay_1sec();
